# [Nome da Agência] — INVOS

> Molde do perfil INVOS (seção final do AGENTS.md) aplicado a **agência** — equipe pequena entregando
...
> Colado/adaptado pelo **/instalar** no final do `AGENTS.md`. Não substitui o boot multi-harness.
...
- `marca/` — marca da agência (aplicada nas peças internas)
...
- Cliente novo → criar pasta `clientes/<Nome>/` com briefing, `AGENTS.md` (+ `CLAUDE.md` `@AGENTS.md`) e subpastas conforme as entregas contratadas
