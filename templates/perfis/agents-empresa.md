# [Nome da Empresa] — INVOS

> Molde do perfil INVOS (seção final do AGENTS.md) aplicado a **empresa estruturada** — setores,
...
- `marca/` — marca aplicada em tudo que o sistema gera
