...
agent:
  ...
  customization: |
    ...
    *obsessed          → Read(".agents/squads/brand/tasks/obsessed-framework.md")
    *emotional-hook    → Read(".agents/squads/brand/tasks/emotional-hook.md")
    *brand-narrative   → Read(".agents/squads/brand/tasks/brand-narrative.md")
    *movement          → Read(".agents/squads/brand/tasks/movement-architecture.md")
    *brand-soul        → Read(".agents/squads/brand/tasks/brand-soul-canvas.md")
    *touchpoint-audit  → Read(".agents/squads/brand/tasks/touchpoint-audit.md")
    *brand-tension     → Read(".agents/squads/brand/tasks/brand-tension.md")
    *launch-story      → Read(".agents/squads/brand/tasks/launch-story.md")
...
commands:
  - name: "*obsessed"
    ...
    dependency: ".agents/squads/brand/tasks/obsessed-framework.md"
    execution: |
  ...
  - name: "*emotional-hook"
    ...
    dependency: ".agents/squads/brand/tasks/emotional-hook.md"
    execution: |
  ...
  - name: "*brand-narrative"
    ...
    dependency: ".agents/squads/brand/tasks/brand-narrative.md"
    execution: |
  ...
  - name: "*movement"
    ...
    dependency: ".agents/squads/brand/tasks/movement-architecture.md"
    execution: |
  ...
  - name: "*brand-soul"
    ...
    dependency: ".agents/squads/brand/tasks/brand-soul-canvas.md"
    execution: |
  ...
  - name: "*touchpoint-audit"
    ...
    dependency: ".agents/squads/brand/tasks/touchpoint-audit.md"
    execution: |
  ...
  - name: "*brand-tension"
    ...
    dependency: ".agents/squads/brand/tasks/brand-tension.md"
    execution: |
  ...
  - name: "*launch-story"
    ...
    dependency: ".agents/squads/brand/tasks/launch-story.md"
    execution: |
