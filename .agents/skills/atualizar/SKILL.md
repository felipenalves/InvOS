...
description: >
  ...
  `estrategia.md`, `AGENTS.md`, `marca/design-guide.md`) que ficaram desatualizados em relação
...
- Skills em `.agents/skills/` — quais existem hoje (`.claude/skills/` deve ser só symlink)
...
- **Em `CLAUDE.md`:** deve ser só `@AGENTS.md` (ponteiro). Se tiver regras de negócio, mover pra `AGENTS.md`.
- **Em `marca/design-guide.md`:** continua coerente com o que foi gerado nas últimas peças (carrosséis, slides)?
