...
description: >
  ...
  skills concretas e cria as aprovadas em `.agents/skills/` (+ symlink em `.claude/skills/`). Use quando o usuário pedir
...
```
Criei [N] skills:
✓ /<nome1> — em .agents/skills/<nome1>/SKILL.md (+ symlink .claude)
✓ /<nome2> — em .agents/skills/<nome2>/SKILL.md (+ symlink .claude)
...
