...
- `CLAUDE.md` do projeto com apenas `@AGENTS.md` (ponteiro multi-harness)
...
Esse projeto herda automaticamente o tom de voz, marca e contexto do negócio definidos em `_memoria/` e `marca/` da raiz. Não duplicar essas informações aqui.
...
Quando for trabalhar nesse projeto, abre o terminal já dentro da pasta — assim o harness carrega o AGENTS.md específico junto com o da raiz.
```
