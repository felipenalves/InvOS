...
- **Skill carrossel:** `.agents/skills/carrossel/SKILL.md` — usar pra fase do carrossel
...
**Sem perguntar, partir direto pra criação do carrossel** chamando `.agents/skills/carrossel/SKILL.md` (tipo 1: carrossel texto puro).
